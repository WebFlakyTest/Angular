...
Additionally, more advanced type-checking as described in Type Checking Templates also requires determining the types of the directives that apply to an element as well as how the attributes map to the properties of the directives.
